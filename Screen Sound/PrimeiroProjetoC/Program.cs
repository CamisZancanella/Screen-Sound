...
//List<string> listaDasBandas = new List<string> { "U2", "Beatles", "Metallica"};
...
void ExibirOpcoesDoMenu()
{
    ...
    switch(opcaoEscolhidaNumerica)
    {
        case 1: RegistrarBanda();
            ...
            case 4: ExibirMedia();
            break;
            case -1: Console.WriteLine("Tchau, Tchau :D");
            break;
...
{
    Console.Clear();
    ExibirTituloOpcoes("Exibindo todas as bandas registradas na aplicação");
...
{
    Console.Clear();
    ExibirTituloOpcoes("Exibir média da banda");
    ...
    if (bandasRegistradas.ContainsKey (nomeDaBanda))
    {
        ...
        Console.WriteLine($"\nA média da banda {notasDaBanda} é {notasDaBanda.Average()}");
        Console.WriteLine("Digite uma tecla para voltar ao menu principal");
        Console.ReadKey();
        Console.Clear();
        ExibirOpcoesDoMenu();
